...
const PRODUCTS = [
  // Tricouri
  { id: "t1", cat: "tricouri", name: "Tricou Trupă A — Tour 2026", price: 90, img: "img/produse/t1-tricou-tour-2026.png", emoji: "🎸", band: "Trupă A", tag: "Nou", sizes: ["S", "M", "L", "XL", "XXL"], origin: "RO" },
  { id: "t2", cat: "tricouri", name: "Tricou Trupă B — Logo", price: 85, img: "img/produse/t2-tricou-logo.png", emoji: "🤘", band: "Trupă B", tag: "", sizes: ["S", "M", "L", "XL"], origin: "RO" },
  { id: "t3", cat: "tricouri", name: "Tricou Band X — Album", price: 110, img: "img/produse/t3-tricou-album.png", emoji: "💀", band: "Band X", tag: "Import", sizes: ["M", "L", "XL", "XXL"], origin: "EXT" },
  { id: "t4", cat: "tricouri", name: "Tricou Band Y — Classic", price: 105, img: "img/produse/t4-tricou-classic.png", emoji: "🔥", band: "Band Y", tag: "", sizes: ["S", "M", "L", "XL"], origin: "EXT" },
  { id: "t5", cat: "tricouri", name: "Tricou Trupă C — Ediție limitată", price: 120, img: "img/produse/t5-tricou-limitat.png", emoji: "⚡", band: "Trupă C", tag: "Limitat", sizes: ["M", "L", "XL"], origin: "RO" },
  { id: "t6", cat: "tricouri", name: "Tricou Band Z — Reprint", price: 95, img: "img/produse/t6-tricou-reprint.png", emoji: "🖤", band: "Band Z", tag: "", sizes: ["S", "M", "L", "XL", "XXL"], origin: "EXT" },
  // Patchuri
  { id: "p1", cat: "patchuri", name: "Patch Trupă A — Brodat", price: 25, img: "img/produse/p1-patch-brodat.png", emoji: "🧷", band: "Trupă A", tag: "Nou", sizes: [], origin: "RO" },
  { id: "p2", cat: "patchuri", name: "Patch Trupă B — Triunghiular", price: 22, img: "img/produse/p2-patch-triunghi.png", emoji: "🔻", band: "Trupă B", tag: "", sizes: [], origin: "RO" },
  { id: "p3", cat: "patchuri", name: "Patch Band X — Back patch mare", price: 45, img: "img/produse/p3-patch-back.png", emoji: "🛡️", band: "Band X", tag: "Import", sizes: [], origin: "EXT" },
  { id: "p4", cat: "patchuri", name: "Patch Band Y — Rotund", price: 20, img: "img/produse/p4-patch-rotund.png", emoji: "⭕", band: "Band Y", tag: "", sizes: [], origin: "EXT" },
  { id: "p5", cat: "patchuri", name: "Patch Trupă C — Logo brodat", price: 28, img: "img/produse/p5-patch-logo.png", emoji: "✴️", band: "Trupă C", tag: "", sizes: [], origin: "RO" },
  { id: "p6", cat: "patchuri", name: "Patch Band Z — Cutie back patch", price: 40, img: "img/produse/p6-patch-cutie.png", emoji: "🪡", band: "Band Z", tag: "", sizes: [], origin: "EXT" },
  // CD-uri
  { id: "c1", cat: "cduri", name: "Trupă A — „Primul Album” CD", price: 50, img: "img/produse/c1-cd-primul-album.png", emoji: "💿", band: "Trupă A", tag: "Nou", sizes: [], origin: "RO" },
  { id: "c2", cat: "cduri", name: "Trupă B — „Live la București” CD", price: 55, img: "img/produse/c2-cd-live.png", emoji: "🎤", band: "Trupă B", tag: "", sizes: [], origin: "RO" },
  { id: "c3", cat: "cduri", name: "Trupă C — „EP 2026” CD", price: 45, img: "img/produse/c3-cd-ep-2026.png", emoji: "📀", band: "Trupă C", tag: "Nou", sizes: [], origin: "RO" },
  // Accesorii
  { id: "a1", cat: "accesorii", name: "Curea de chitară — Model Metal", price: 75, img: "img/produse/a1-curea-chitara.png", emoji: "🎸", band: "RoRock Gear", tag: "Nou", sizes: [], origin: "RO" },
  { id: "a2", cat: "accesorii", name: "Broșă / Pin — Logo RoRock", price: 15, img: "img/produse/a2-pin-rorock.png", emoji: "📌", band: "RoRock Gear", tag: "", sizes: [], origin: "RO" },
  { id: "a3", cat: "accesorii", name: "Brățară din piele — Tâșnăi", price: 30, img: "img/produse/a3-bratara-piele.png", emoji: "⛓️", band: "RoRock Gear", tag: "", sizes: [], origin: "RO" },
  { id: "a4", cat: "accesorii", name: "Breloc — Chitară electrică", price: 20, img: "img/produse/a4-breloc-chitara.png", emoji: "🔑", band: "RoRock Gear", tag: "", sizes: [], origin: "RO" },
  { id: "a5", cat: "accesorii", name: "Pene de chitară — Set 5 buc.", price: 25, img: "img/produse/a5-pene-chitara.png", emoji: "🎶", band: "RoRock Gear", tag: "", sizes: [], origin: "RO" },
  { id: "a6", cat: "accesorii", name: "Cangur pentru vestă de patchuri", price: 60, img: "img/produse/a6-vesta-patchuri.png", emoji: "🎒", band: "RoRock Gear", tag: "Limitat", sizes: [], origin: "RO" },
];

function productThumb(p, alt) {
  if (p && p.img) return `<img src="${p.img}" alt="${alt || p.name}" />`;
  return `<span aria-hidden="true">${(p && p.emoji) || "🤘"}</span>`;
}
...
function addToCart(id, size) {
  ...
  else cart.push({ key, id, name: p.name, price: p.price, img: p.img, emoji: p.emoji, size: size || null, qty: 1 });
  saveCart(cart);
  ...
  if (!cart.length) {
    ...
    list.innerHTML = cart
      .map(
        (i) => `
      <div class="cart-item">
        <div class="cart-item-thumb">${productThumb(PRODUCTS.find((x) => x.id === i.id) || i, i.name)}</div>
        <div>
